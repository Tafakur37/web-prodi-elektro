                ...
                <div class="card-body p-0" style="max-height: calc(100vh - 280px); overflow-y: auto;">
                    <div class="list-group list-group-flush border-0" id="contacts-list">
                        @forelse($recentContacts as $contact)
                            ...
                            @endphp
                            <a href="{{ route('staff.chats.show', $contact->id) }}" class="list-group-item list-group-item-action px-4 py-3 border-light d-flex align-items-center justify-content-between">
